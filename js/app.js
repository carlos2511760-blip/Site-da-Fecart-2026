(() => {
  ...
  async function uploadAppFile(field) {
    ...
    try {
      ...
      if (field.dataset.uploadPath.includes(':member:')) { await saveGroupsToDatabase(); $('#editor-status').textContent = 'Foto enviada e salva para todos.'; } else $('#editor-status').textContent = 'Arquivo enviado. Clique em salvar para publicar para todos.';
